...
function AddDietComponent({ user, openAddDietModal, setOpenAddDietModal, getDietLogs }) {
  ...
  return (
    <Transition.Root show={openAddDietModal} as={Fragment}>
      <Dialog as="div" className="relative z-10" onClose={() => setOpenAddDietModal(false)}>
        <Transition.Child
          as={Fragment}
                    ...
                    <div className="mt-2">
                      {
                        items.map((item, index) => 
                          ...
                          >
                            {item}
                            <button type="button" onClick={() => handleItemDelete(index)}>
                              <svg xmlns="http://www.w3.org/2000/svg" fill="black" viewBox="0 0 24 24" strokeWidth={1.5} stroke="currentColor" className="ml-1 w-4 h-4">
